...
export function ClientLayount() {
  return (
    <>
      <Helmet title="Client" />
      <div className="divide-divide-main bg-bg-main bg-wallpaper flex min-h-screen flex-col divide-y-[1px] border-[1px] border-zinc-800 bg-cover bg-center bg-no-repeat">
        <ClientHeader />
